# freee_report_v2.py : v1 ＋ AI診断コメント を v4と同じ「1枚カード」に（コメント1段）
#   ★AIへの指示プロンプトはv2のまま無変更（表を丸ごと渡す版）
...
for i, (lab, val, col) in enumerate([("収入", f"{income/10000:.1f}万円", "#222"),
...
fig.savefig("freee_report_v2.png", dpi=150, bbox_inches="tight", facecolor="white")
print("\n1枚レポートを freee_report_v2.png に保存しました")
